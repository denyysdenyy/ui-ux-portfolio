...
import imgBg from '../public/img/bg-hero.webp'
...
const Hero = async () => {
  ...
  return (
    <section id="hero" className="relative bg-black overflow-hidden flex flex-col">
      ...
      <Container>
        <div className="flex items-center justify-center relative z-10">
          <div className="flex flex-col items-center">
            ...
            <p className="mb-[clamp(40px,7vw,118px)] font-[500] max-w-[1336px] text-center text-[clamp(18px,2.5vw,38px)] tracking-tighter">
              {t("subtitle1")} <br />
              {t("subtitle2")}
            </p>
            <Button />
          ...
          <div className="hidden lg:flex flex-col gap-[30px] absolute right-0 top-[100px]">
            {socials.map((social) => (
              <Link
                className="bg-black p-[20px]   border-2 border-transparent rounded-[100px] hover:border-secondary duration-300 transition-all"
                key={social.id}
                href={"#"}
              >
                <Image
